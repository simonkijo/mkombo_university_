      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="admissionOfficer.php"><i class="fa fa-file-o"></i> <span>Bachelor Degree</span></a></li>
  ...
  <div class="content-wrapper">
	...
	?>
					...
					<div class="col-md-3">
						<div class="form-group">
							<label></label><br>
							<button type="submit" name="adm_show" class="btn btn-primary">Show</button>
						</div>
					</div>
				</div>
			</form>
