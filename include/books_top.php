...
<?php	
	...
	$result=mysql_query("SELECT username,email_address,phone_no,role from staff where role='Librarian' ") or die(mysql_error());//card_id="$_POST['password']" AND your_full_name="$_POST['username']");
...
if(isset($_POST['setting']))
	{
	 ...
	 $countt=mysql_query("SELECT * FROM staff WHERE  email_address='$email' AND  role='Librarian'");
	...
	{
mysql_query("UPDATE staff SET username='$fname' , email_address='$email' , phone_no='$phone' , role='Librarian' , password='$password' WHERE role='Librarian' ") or die(mysql_error());	            
$result=mysql_query("SELECT username,email,phone,position from profile where role='Librarian' ") or die(mysql_error());//card_id="$_POST['password']" AND your_full_name="$_POST['username']");
	while($row=mysql_fetch_array($result))
	{ 
	$full_name=$row['username'];
	$the_email=$row['email_address'];
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="profile_librarian.php" class="btn btn-default btn-flat">Profile</a>
                </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li><a href="book_new.php">
		<i class="fa fa-circle-o text-red"></i> <span>Enter record</span></a></li>
		<li><a href="book_detail.php">
		<i class="fa fa-circle-o text-red"></i> <span>Detail</span></a></li>
		<li><a href="book_borrow.php">
		<i class="fa fa-circle-o text-red"></i> <span>Borrow</span></a></li>
