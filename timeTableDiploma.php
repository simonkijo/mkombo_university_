			...
			if(isset($success)){
				if($success[1] == 'success'){
					...
					echo "<div class='callout callout-info'>
						<h4>INFORMATION !</h4>
						<p>The Class Time Table for ".$year." year, ".$semester." semester and ".$course." course already created. If you want to edit click <a href='timeTableDiplomaEdit.php'>HERE</a></p>
					</div>";
				}	
			}
			...
			<form method="post" enctype="multipart/form-data">
				<div class="row" style="margin:2% auto;">
					...
					<div class="col-md-3">
						<div class="form-group">
							<label></label><br>
							<button type="submit" name="sv_time_od" class="btn btn-primary">Show</button>
						</div>
					</div>
					<!-- -->
				</div>
			...
			echo '<div class="row">
				...
				echo '<div class="row">
					...
					<div class="col-md-3">
						<div class="form-group">
							<label></label><br>
							<button type="submit" name="sv_time_od_md" class="btn btn-primary">Create</button>
						</div>
					</div>
				</div>';
			}
