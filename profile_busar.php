...
if(isset($_POST['setting']))
	{
	 ...
	 $countt=mysql_query("SELECT * FROM staff WHERE  email_address='$email' AND  role='Busar'");
	...
	{
mysql_query("UPDATE staff SET username='$fname' , email_address='$email' , phone_no='$phone' , role='Busar' , password='$password' WHERE role='Busar' ") or die(mysql_error());	            
$result=mysql_query("SELECT username,email,phone,position from profile where role='Busar' ") or die(mysql_error());//card_id="$_POST['password']" AND your_full_name="$_POST['username']");
	while($row=mysql_fetch_array($result))
	{ 
	$full_name=$row['username'];
	$the_email=$row['email_address'];
        ...
        <li class="active treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Financial</span> <i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
				...
				<li class="active"><a href="profile_busar.php"><i class="fa fa-circle-o"></i> <span>Profile</span></a></li>
			</ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
        ...
        <div class="col-md-4">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center"><?php echo firstCapitalLetter(getField('sname')).', '.firstCapitalLetter(getField('fname'));?></h3>

              <p class="text-muted text-center">Busar</p>
