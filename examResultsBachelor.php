    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li class="active treeview">
			...
			<ul class="treeview-menu">
				<li class="active"><a href="examResultsBachelor.php"><i class="fa fa-circle-o"></i> <span>Bachelor Degree</span></a></li>
...
<?php 
	include('data/examResultsData.php');
?>
...
?>
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="form-group">
						<label></label><br>
						<button type="submit" name="print_b" class="btn btn-primary">Print</button>
					</div>
				</div>
			</div>
			</form>
