      ...
      <ul class="sidebar-menu">
		...
		<li class="active treeview">
          ...
          <ul class="treeview-menu">
			...
			<li class="active"><a href="admissionOfficerReportDiploma.php"><i class="fa fa-file-o"></i> <span>Ordinary Diploma</span></a></li>
          </ul>
        </li>
...
<?php 
	include('data/admissionOfficerReportDiplomaData.php');
?>
	...
	?>
					...
					<div class="col-md-3">
						<div class="form-group">
							<label></label><br>
							<button type="submit" name="adm_od_print" class="btn btn-primary">Print</button>
						</div>
					</div>
				</div>
			</form>
