          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
				...
				<li class="list-group-item">
                  <b>index</b> <a class="pull-right">120128</a>
                </li>
              </ul>
            </div>
            <!-- /.box-body -->
			 ...
			 <div class="tab-pane" id="settings">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-sm-10 error_phone  has-feedback">
                      <input type="text" class="form-control phone" name="phone" id="phoneValidate" placeholder="phone" maxlength="16" minlength="8">
			      ...
			      <div class="form-group ">
                    ...
                    <div class="col-sm-10 has-feedback error_password">
                      <input type="password" class="form-control password" name="password" placeholder="password" placeholder="phone" maxlength="16" minlength="8">
...
include('include/adminprofile_bottom.php');
